...
import S_J_crousel from "./S_J_crousel";
  ...
  return (
    <div className="w-full">
      <div className="Banner w-full h-[100vh] flex items-center ">
        <div className=" w-full h-[80vh] flex justify-center overflow-x-scroll no-scrollbar before:absolute before:left-0 before:z-40 before:w-[30vw] before:h-full before:bg-gradient-to-r from-[#f4f4f5] to-transparent after:absolute after:z-40 after:w-[30vw] after:h-full after:right-0 after:bg-gradient-to-l from-[#f4f4f5] to-transparent">
      ...
      <div className="ViewAll_btn flex justify-center m-20">
           <Link to={`/all`}>
           <button className="border border-black p-3 rounded-3xl hover:bg-white transition duration-300 hover:scale-105">View All products</button></Link>
      </div>
    </div>
  );
}
